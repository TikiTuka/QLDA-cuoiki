...
export default function Toast({ message, type = 'info', onClose, duration = 3000 }) {
  ...
  const getToastStyle = () => {
    const baseStyle = 'fixed top-4 right-4 z-50 p-4 rounded-lg shadow-md border min-w-[300px] max-w-[400px] transition-all duration-300 transform';

    switch (type) {
      case 'success':
        return `${baseStyle} bg-green-50 border-green-300 text-green-800`;
      case 'error':
        return `${baseStyle} bg-red-50 border-red-300 text-red-800`;
      case 'warning':
