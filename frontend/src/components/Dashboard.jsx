    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-xl p-6 text-white mb-8 shadow-lg">
          ...
          <p className={`text-3xl font-bold mt-2 ${userBalance >= 0 ? 'text-white' : 'text-red-200'}`}>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-green-50 p-4 rounded-lg">
                  <h4 className="font-medium text-green-800">Thu nhập tháng này</h4>
                ...
                <div className="bg-red-50 p-4 rounded-lg">
                  <h4 className="font-medium text-red-800">Chi tiêu tháng này</h4>
          ...
          {activeTab === 'add-money' && (
            <div>
              <h3 className="text-xl font-semibold mb-4">Nạp tiền vào tài khoản</h3>
